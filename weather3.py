...
#    sparsity = 0.01
    ...
    print("Building RC...")
    rc = stochasticRC(5 * num_samples, nn, 5 * num_samples, sparsity=sparsity,
            ns=ns)
...
#
    ...
    rc2 = stochasticRC(5 * num_samples, nn, 5 * num_samples, sparsity=sparsity,
            ns=ns)
